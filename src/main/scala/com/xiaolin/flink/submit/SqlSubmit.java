...
package com.xiaolin.flink.submit;


import com.xiaolin.flink.submit.cli.CliOptions;
import com.xiaolin.flink.submit.cli.CliOptionsParser;
import com.xiaolin.flink.submit.cli.SqlCommandParser;
...
public class SqlSubmit {
    ...
    public static void main(String[] args) throws Exception {
        ...
        str[0] = "-w /src/main/resources/";
        str[1] = "-f q1.sql";
        final CliOptions options = CliOptionsParser.parseClient(str);
