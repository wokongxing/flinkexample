...
object JoinApp {
  def main(args: Array[String]): Unit = {
    ...
    val consumer = new FlinkKafkaConsumer[String]("ruozedata_offset", new SimpleStringSchema(), properties)
    ...
    logStream.connect(mysqlStream)
      .flatMap(new RichCoFlatMapFunction[(String,String,String),mutable.HashMap[String, String], String] {
